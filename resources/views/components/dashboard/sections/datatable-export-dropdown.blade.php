        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y">
                    <form id="kt-{{ $model }}-export-form" class="form" action="{{ route($model . '.export') }}" method="get">
                        <div class="row gy-5">
                            @php
                                $formats = [
                                    [
                            ...
                            @endforeach
                            <x-dashboard.fields.input type="text" name="date" :value="old('date')" cols="col-12" label="Select Date Range" placeholder="Select Date Range" />
...
@push('scripts')
    <script>
        ...
        var KTSubscriptionsExport = function() {
            ...
            return {
                init: function() {
                    t = document.querySelector("#kt-{{ $model }}-export-modal"),
                        a = new bootstrap.Modal(t),
                        r = document.querySelector("#kt-{{ $model }}-export-form"),
                        function() {
